...
Gradle build script : PasswordGenerator
...
val packageName     = "passwordgenerator"
val mainClassName   = "uk.blankaspect.${packageName}.PasswordGeneratorApp"

val buildDir    = layout.buildDirectory.get().getAsFile().toString()
val jarDir      = _path(buildDir, "bin")
val jarFilename = "passwordGenerator.jar"
