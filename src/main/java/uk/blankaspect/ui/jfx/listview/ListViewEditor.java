...
////////////////////////////////////////////////////////////////////////
		...
		boolean		imageButtons)
	{
		...
		for (Action action : editor.getActions())
		{
			...
			{
				// Create button
				button = Buttons.hNoShrink(action.text + (editor.requiresEllipsis(action) ? ELLIPSIS_STR : ""));
...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		/**
		 * Returns {@code true} if the button text for the specified action requires a trailing ellipsis.
		 *
		 * @param  action
		 *           the editing action.
		 * @return {@code true} if the button text for the specified action requires a trailing ellipsis.
		 */

		default boolean requiresEllipsis(
			Action	action)
		{
			return false;
		}
