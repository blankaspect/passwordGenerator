### blankaspect/passwordGenerator

This repository contains the source code and resources of the PasswordGenerator application.  The repo conforms to the
...
You can find more information about PasswordGenerator on the project's
[home page](https://blankaspect.github.io/passwordGenerator/).
...
PasswordGenerator is a non-modular JavaFX application.  The `compileJava`, `jar`, `runMain` and `runJar` tasks expect
...
* You may use the contents of the `uk.blankaspect.passwordgenerator` package \(including resources\) under the terms and
